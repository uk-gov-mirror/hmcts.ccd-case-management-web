Feature: Hide and show of fields using a complex type

  Scenario Outline: field within a complex type appears when hide and show condition within a complex type is met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
  ...
  Scenario Outline: field within a complex type does not appear when hide and show condition within a complex type is not met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
  ...
  Scenario Outline: field outside a complex type appears when hide and show condition within a complex type is met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
    When I complete the <showConditionType> condition for the field
    Then a '<mandatoryOptionalHiddenField>' basic field will be displayed outside the complex type
    And I fill out the Mandatory fields
    And I am able to submit the case
  ...
  Scenario Outline: field outside a complex type does not appear when hide and show condition within a complex type is met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
    When I do not complete the <showConditionType> condition for the field
    Then a '<mandatoryOptionalHiddenField>' basic field will not be displayed outside the complex type
    And I fill out the Mandatory fields
    And I am able to submit the case
  ...
  Scenario Outline: field on next page appears when hide and show condition within a complex type is met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
    When I complete the <showConditionType> condition for the field
  ...
  Scenario Outline: field on next page does not appear when hide and show condition within a complex type is not met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
    When I do not complete the <showConditionType> condition for the field
    And navigate to the next page
  ...
  Scenario Outline: page on same event appears when hide and show condition in complex type is met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
    When I complete the <showConditionType> condition for the field
    And navigate to the next page
  ...
  Scenario Outline: page on same event does not appear when hide and show condition in complex type is not met
    Given there is a complex type containing a '<mandatoryOptional>' '<fieldType>' field
    When I do not complete the <showConditionType> condition for the field
    And navigate to the next page
