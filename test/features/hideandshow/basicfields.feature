Feature: Hide and show of basic fields
  ...
  Scenario Outline: field on same page appears when hide and show condition is met
    Given there is a '<mandatoryOptional>' '<fieldType>' field
  ...
  Scenario Outline: field on next page appears when hide and show condition is met
    Given there is a '<mandatoryOptional>' '<fieldType>' field
    When I complete the <showConditionType> condition for the field
  ...
  Scenario Outline: field on same page does not appear when hide and show condition is not met
    Given there is a '<mandatoryOptional>' '<fieldType>' field
  ...
  Scenario Outline: field on next page does not appear when hide and show condition is not met
    Given there is a '<mandatoryOptional>' '<fieldType>' field
    When I do not complete the <showConditionType> condition for the field
    And navigate to the next page
    Then a '<mandatoryOptionalHiddenField>' basic field basic field will not be displayed
  ...
  Scenario Outline: page on same event appears when hide and show condition is met
    Given there is a '<mandatoryOptional>' '<fieldType>' field
  ...
  Scenario Outline: page on same event does not appear when hide and show condition is met
    Given there is a '<mandatoryOptional>' '<fieldType>' field
    When I do not complete the <showConditionType> condition for the field
    And navigate to the next page
